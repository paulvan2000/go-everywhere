...
private static final long serialVersionUID = 0L;
  ...
  private double distanceFromStartKm_ = 0D;
  /**
  ...
  private double durationFromStartMin_ = 0D;
  /**
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.example.goeverywhere.protocol.grpc.Waypoint result) {
      if (waypointMetadataBuilder_ == null) {
    ...
    private void buildPartial0(org.example.goeverywhere.protocol.grpc.Waypoint result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              org.example.goeverywhere.protocol.grpc.WaypointMetadata m =
                  input.readMessage(
                      org.example.goeverywhere.protocol.grpc.WaypointMetadata.parser(),
                      extensionRegistry);
              if (waypointMetadataBuilder_ == null) {
                ensureWaypointMetadataIsMutable();
                waypointMetadata_.add(m);
              } else {
                waypointMetadataBuilder_.addMessage(m);
              }
              break;
            } // case 34
            default: {
